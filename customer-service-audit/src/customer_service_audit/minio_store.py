"""MinIO object primitives used by fixtures, UDFs, and the JSON writer."""
...
class MinioStore:
    """Provide the object operations used by probes, ASR, AI, and publication."""
    ...
    def list_object_keys(self, bucket: str, prefix: str) -> list[str]:
        """List object keys under one prefix in lexicographic order."""
